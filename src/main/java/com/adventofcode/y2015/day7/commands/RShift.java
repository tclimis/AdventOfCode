...
public class RShift extends BinaryOperator {

	public RShift(String param1, String param2, String variable) {
	...
	public void execute() {
		if( getValue1() != null ) {
			Integer computedValue = Computer.getInstance().rshift(getValue1(), getValue2().intValue());
