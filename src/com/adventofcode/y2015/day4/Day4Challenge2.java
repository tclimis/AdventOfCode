...
public class Day4Challenge2 extends AbstractChallenge {
	...
	public String execute(String inputFile) {
		...
		for( String line : fileParser.getFileLines() ) {
			int i = 1;
			while( !md5StartsWith000000(line, i) ) {
				i++;
			}
	...
	private boolean md5StartsWith000000(String line, int number) {
		...
		try {
			...
			return (md5Bytes[0] == 0 && md5Bytes[1] == 0 && md5Bytes[2] == 0);
